...
| **Exp 3** | 로컬 소형 모델에서 triad Aufhebung | 창의적 종합이 소형 로컬 모델(3–12B, reasoning·비-reasoning)에서도 재현되는가? | 3 로컬 모델 × triad × 5항목 × 3반복 = **45** | `exp3_runs.jsonl`·`exp3_analysis.json` | `EXP3_STUDY.*` |
