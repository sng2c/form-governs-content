...
📐 **Control panel spec**: [`report/CONTROL_PANEL_SPEC.en.md`](report/CONTROL_PANEL_SPEC.en.md) (English) · [`report/CONTROL_PANEL_SPEC.md`](report/CONTROL_PANEL_SPEC.md) (한국어)
